...
python train.py --config_path ./configs_yaml/0622config/config0622_E15_M0.27_M0.09.yaml --result_path ./result_0622/ --fold_num 5 || true
python train.py --config_path ./configs_yaml/0622config/config0622_E100.yaml --result_path ./result_0622/  || true
