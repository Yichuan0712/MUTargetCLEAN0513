...
def main(config_dict, args,valid_batch_number, test_batch_number):
    ...
    tools = {
        ...
        'loss_function_nucleus': torch.nn.BCEWithLogitsLoss(pos_weight=w_nucleus, reduction="none"),
        'loss_function_nucleus_export': torch.nn.BCEWithLogitsLoss(pos_weight=w_nucleus_export, reduction="none"),
        'pos_weight': w,
