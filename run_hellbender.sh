...
python train.py --config_path ./configs/config_nosupcon_CNNlinear_yichuan_drop0.3.yaml \
--result_path ./result_nosupcon/cnnlinear_decoder/cnn2linear_c32_k7_drop0.3
#1594176